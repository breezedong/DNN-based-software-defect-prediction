...
l1 = add_layer(xs, 39, 170, activation_function=tf.nn.relu)
l2 = add_layer(l1, 170, 170, activation_function=tf.nn.relu)
l3 = add_layer(l2, 170, 170, activation_function=tf.nn.relu)
l4 = add_layer(l3, 170, 170, activation_function=tf.nn.relu)

# add output layer 输入值是隐藏层 l1，在预测层输出 1 个结果
prediction = add_layer(l4, 170, 2, activation_function=None)
