...
l5 = add_layer(l4, 150, 150, activation_function=tf.nn.relu)
l6 = add_layer(l5, 150, 150, activation_function=tf.nn.relu)
l7 = add_layer(l5, 150, 150, activation_function=tf.nn.relu)

# add output layer 输入值是隐藏层 l1，在预测层输出 1 个结果
prediction = add_layer(l7, 150, 2, activation_function=None)
